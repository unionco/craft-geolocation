...
define('CRAFT_VENDOR_PATH', '/var/www/vendor');
// var_dump(__DIR__);die;
$devMode = true;

$vendorPath = realpath(CRAFT_VENDOR_PATH);
// var_dump($vendorPath); die;
...
// Load the files
$srcPath = CRAFT_VENDOR_PATH . '/craftcms/cms/src';
$libPath = CRAFT_VENDOR_PATH . '/craftcms/cms/lib';
...
$app = \Craft::createObject(require $configPath . '/test.php');


Craft::$app->getPlugins()->installPlugin('geolocation');
// return $app;
